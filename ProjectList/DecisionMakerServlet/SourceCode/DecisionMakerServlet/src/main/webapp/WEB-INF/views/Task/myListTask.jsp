...
<div>
  <form:form name="myListTask" class="horizontal" enctype="multipart/form-data" action="myListTask" modelAttribute="model" method="GET">
    <div class="visible" style="background: #eee">
        ...
        <label><s:message code="Task_I_do"/></label>
        <form:checkbox path="request.assigneeUsername" value="${pageContext.request.userPrincipal.name}"/>
        
        <label><s:message code="Task_I_manage"/></label>
        <form:checkbox path="request.managerUsername" value="${pageContext.request.userPrincipal.name}"/>
