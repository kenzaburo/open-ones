...
<link rel="stylesheet" media="screen" href="resources/handsontable/lib/jquery-ui/css/ui-bootstrap/jquery-ui.custom.css">
        ...
        <div>
          ...
          <div class="col_8 column view-pager">
            <ul id="pager-top" class="view-pager-ui">
              <li class="view-pager-previous"><a href="javascript:;">&lt; Trước</a></li>
              <li>
                <ul class="view-pager-links">
                  <li class="view-pager-pageLink"><a href="">1</a></li>
                  <li class="flc-pager-pageLink-disabled">2</li>
                  <li class="flc-pager-pageLink"><a href="javascript:;">3</a></li>
                </ul>
              </li>
              <li class="view-pager-next"><a href="javascript:;">Tiếp &gt;</a></li>
              <li>
                <span class="view-pager-summary">Hiển thị</span>
