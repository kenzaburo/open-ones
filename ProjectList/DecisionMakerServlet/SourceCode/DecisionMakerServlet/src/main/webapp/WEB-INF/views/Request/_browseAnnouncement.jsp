...
<div id="browse-Announcement">
		...
		<div>
            ...
            <a href="#" onclick='viewRequestContent("viewRule?id=${model.request.id}", "<s:message code="Announcement_content"/>")'><s:message code="View_in_another_window"/></a>
		</div>
