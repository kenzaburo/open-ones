...
<%
	...
	GroupUpdateBean beanGroupUpdate = (GroupUpdateBean)request.getAttribute("beanGroupUpdate");
%>
...
function doSave()
{
	var form = document.frmGroupUpdate;
	...
	form.hidActionDetail.value = "SaveUpdateGroup";
...
<div ><p><img border="0" src="Images/GroupUpdate.gif" width="411" height="28"></p></div>
...
<table border="0" width="100%">
  ...
  <!-- ************************************  Form Body  ************************************ -->
	<form method="post" action = "DMSServlet" name="frmGroupUpdate">
     ...
     <tr>
     	...
     	<table border="0" cellspacing="1" cellpadding="0" width="100%" bgcolor="#000000">
              <tr class="Row0">
                <td align="center" width="65%" height="19">Name</td>
              </tr>
              <tr class="Row2">
	  ...
	  <!-- ************************************  Form Code Here  ************************************ -->
		...
		<p align="center"><input type="button" name="UpdateGroup" class="Button" onClick='javascript:doSave()' value="Update">&nbsp;&nbsp;&nbsp;&nbsp;
