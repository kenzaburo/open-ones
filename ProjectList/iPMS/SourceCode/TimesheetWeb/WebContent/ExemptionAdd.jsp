...
%>
	...
	<TR>
		...
		<TD width="39%" align="center">
		<p align="left">
           <INPUT id="txtFromDate" type="text" name="txtFromDate" size="20" maxlength="8" value="<%=(beanExemptionInfo.getFromDate() == null) ? "" : beanExemptionInfo.getFromDate() %>" class="SmallTextbox">
        <%-- 
	...
	<TR>
		...
		<TD width="39%" align="center">
		<p align="left">
           <INPUT id="txtToDate" type="text" name="txtToDate" size="20" value="<%=(beanExemptionInfo.getToDate() == null) ? "" : beanExemptionInfo.getToDate() %>" maxlength="8" class="SmallTextbox">
           <%-- 
