...
<HTML>
<HEAD>
<TITLE>Lack Timesheet Project</TITLE>
...
<H3><FONT color="yellow">Lack Timesheet Project</H3>
...
<TABLE border="0" cellpadding="2" cellspacing="0" width="100%" align="center" id="table1">
     <TR>
    	...
    	<%if ( strRole.equals("1111110000") || strRole.equals("1000100000") ) {%>
        	...
        	<%for (int nRow = 1; nRow < smtGroupList.getNumberOfRows(); nRow++) {
        ...
        <TD width="11%">&nbsp;</TD>
        <TD width="11%">
        	<STRONG><FONT color="#ffffff" class="label1">From date </FONT>
			<FONT color="#FF0000" class="label1">*</FONT></STRONG>
        </TD>
        <TD width="20%">
	...
	<TR>
        ...
        <TD>
        	<SELECT name="cboProjectStatus" onchange="changeCombo()" size="1" class="BigCombo">
            	...
            	<OPTION value="<%=beanWeeklyReport.PROJECT_STATUS_CLOSED%>" <%=beanWeeklyReport.getProjectStatus() == beanWeeklyReport.PROJECT_STATUS_CLOSED ? "selected" : ""%>>Closed</OPTION>
			</SELECT>
		</TD>
    </TR>
    <TR>
    <!----------------------------- LOG BY ------------------------------------->
        <TD width="7%">
        	<FONT color="#ffffff" class="label1">Log By </FONT>
      ...
      --%>
			<INPUT type="text" name="txtLogTimeTracking" size="5" value=<%=beanWeeklyReport.getLogTime()%> maxlength="5" class="verySmallTextbox"></TD>
        <TD width="11%"></TD>
        <TD width="11%">&nbsp;</TD>
        <TD width="20%">&nbsp;</TD>
        <TD width="9%"></TD>
