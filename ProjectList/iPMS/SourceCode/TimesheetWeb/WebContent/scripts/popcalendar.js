...
//                                    - Replace string 'Presione para seleccionar un a�o' with
...
if (dom) {
    ...
    document.write ('<div onclick="bShow=true" id="calendar" style="z-index:+999;position:absolute;visibility:hidden;"><table width="'+((showWeekNumber==1)?250:220)+'" class="pcalTbl"><tr bgcolor="#000066"><td><table width="'+((showWeekNumber==1)?248:218)+'"><tr><td class="pcalCaption"><font color="#ffffff' + '' /*C9D3E9*/ +'"><b><span id="caption"></span></b></font></td><td align="right"><a href="javascript:hideCalendar()"><img src="'+imgDir+'pcalclose.gif" width="15" height="13" border="0" /></a></td></tr></table></td></tr><tr><td style="padding:5px" bgcolor="#ffffff"><span id="content"></span></td></tr>');
...
function constructMonth() {
    ...
    if (!monthConstructed) {
        ...
        document.getElementById('selectMonth').innerHTML = '<table width="70" class="pcalTblList" cellspacing="0" onmouseover="clearTimeout(timeoutID1)" onmouseout="clearTimeout(timeoutID1);timeoutID1=setTimeout(\'popDownMonth()\',100);event.cancelBubble=true">' + sHTML + '</table>';
...
function constructYear() {
    ...
    if (!yearConstructed) {
        ...
        document.getElementById('selectYear').innerHTML = '<table width="44" cellspacing="0" class="pcalTblList" onmouseover="clearTimeout(timeoutID2)" onmouseout="clearTimeout(timeoutID2);timeoutID2=setTimeout(\'popDownYear()\',100)">' + sHTML + '</table>';
            ...
            if (formatChar != "") {
                ...
                for (i=0; i<3; i++) {
                    if ((aFormat[i] == "d") || (aFormat[i] == "dd")) {
                        ...
                        for (j=0; j<12; j++) {
                            if ((aData[i] != null) && (aData[i].toLowerCase() == monthName[language][j].toLowerCase())) {
                                monthSelected=j;
                                tokensChanged++;
                            }
                        }
