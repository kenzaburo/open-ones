...
%>
        ...
        <TD width="26%">
          <INPUT id="apvFromDate" type="text" name="apvFromDate" value="<%=beanQAList.getFromDate()%>" size="20" class="smallTextbox" maxlength="8">
        <%--
...
%>
        ...
        <TD width="25%">
          <INPUT id="apvToDate" type="text" name="apvToDate" value="<%=beanQAList.getToDate()%>" size="20" class="smallTextbox" maxlength="8">
        <%-- 
