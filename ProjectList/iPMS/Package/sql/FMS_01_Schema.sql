...
/
COMMENT ON TABLE CONTRACT_TYPE IS 'List of Contract Type, see WO of Project Insight'
/
...
CREATE TABLE RMS_USER_ROLE (
	RMS_USER_ROLE_ID	NUMBER NOT NULL,
	DEVELOPER_ID         	NUMBER NULL,
	PROJECT_ID           	NUMBER NULL,
	ROLE_ID           	NUMBER NULL
)
/
COMMENT ON TABLE RMS_USER_ROLE IS 'Open-Ones adds'
/
/** project_position_code
RESPONSIBILITY.project_position_code
*/

CREATE TABLE RMS_PROJECT_POSITION_ROLE (
	PROJECT_POSITION_CODE	VARCHAR2(100) NULL,
	ROLE_ID           	NUMBER NULL
)
/
COMMENT ON TABLE RMS_PROJECT_POSITION_ROLE IS 'Open-Ones adds'
/
