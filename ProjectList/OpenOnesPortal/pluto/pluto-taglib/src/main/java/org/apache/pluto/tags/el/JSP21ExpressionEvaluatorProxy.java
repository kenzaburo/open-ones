...
class JSP21ExpressionEvaluatorProxy extends ExpressionEvaluatorProxy {
	...
	private static JspFactory jspFactory;
	...
	static {
		try {
			...
			jspApplicationContextGetter = jspFactory.getClass().getMethod(
					"getJspApplicationContext",
					new Class[] { ServletContext.class });
			expressionFactoryGetter = Class.forName(
					"javax.servlet.jsp.JspApplicationContext").getMethod(
					"getExpressionFactory", new Class[0]);
			elContextGetter = PageContext.class.getMethod("getELContext",
					new Class[0]);
			valueExpressionGetter = Class.forName("javax.el.ExpressionFactory")
					.getMethod(
							"createValueExpression",
							new Class[] { Class.forName("javax.el.ELContext"),
	...
	public String evaluate(String value, PageContext pageContext)
		...
		JspApplicationContext jspApplicationContext = jspFactory.getJspApplicationContext(pageContext.getServletContext());
		ExpressionFactory expressionFactory = jspApplicationContext
				.getExpressionFactory();
		ELContext elContext = pageContext.getELContext();
		ValueExpression valueExpression = expressionFactory
				.createValueExpression(elContext, value, Object.class);
		Object evaluated = valueExpression.getValue(elContext);
