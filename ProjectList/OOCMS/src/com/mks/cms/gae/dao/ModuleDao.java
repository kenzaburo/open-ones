...
import com.mks.cms.gae.dto.ModuleContentDTO;
...
public class ModuleDao {
    ...
    public ModuleDao(String logonId, String email) {
        this.logonId = logonId;
        this.userEmail = email;
    }
    // final static String MOD_ID = "intro";

    public boolean save(ModuleDTO module) {
     ...
     * @return
     */
    public boolean saveContent(Long key, Text tabContent, String langCd) {
        ...
        if (logonId != null) {
            moduleContentDTO.setCreatedBy(userEmail);
        }
    ...
    /**
     * Update information of ModuleDTO. Current support: update orderNo
