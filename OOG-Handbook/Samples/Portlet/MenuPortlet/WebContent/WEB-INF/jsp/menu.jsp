...
<script type="text/javascript" language="javascript">
    showPanel = function() {
        var panelInformation = document.getElementById("panelInformation");
        panelInformation.style.top = '25px';
        panelInformation.style.left = '-300px';
        panelInformation.style.display = "inline";


    }
    hidePanel = function() {
        var panelInformation = document.getElementById("panelInformation");
        panelInformation.style.display = "none";
    }
</script>

<div style="float: right; position: relative;">
    <a onmouseover="showPanel()" onmouseout="hidePanel()">
        <span id="ctl00_LoginInfo1_LoginDetail">Demo</span>
    </a>&nbsp;&nbsp;| &nbsp;
    <div id="panelInformation" style="width: 300px; 
        ...
        <table width="100%">
            <tbody><tr>
                ...
                <td>
                    <span id="ctl00_LoginInfo1_lblUserName">Demo</span>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <span id="ctl00_LoginInfo1_lblFullName">Lê Thị Thu Trang</span>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <span id="ctl00_LoginInfo1_lblPhoneNo">0932633514</span>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <span id="ctl00_LoginInfo1_lblLastLogin">18/07/2012 9:18:07 CH</span>
                </td>
            </tr>
        </tbody></table>
    </div>
    <a id="ctl00_LoginInfo1_LoginStatus1" href="#">Thoát</a>
</div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tbody><tr>
                        <td style="width: 50%;" align="left">
                            <div class="FunctionName" style="float: left;">
                                <span id="ctl00_lblFunctionName">Danh mục » Loại công việc</span></div>
                        </td>
                        <td align="right">
                            
<div>
    <span id="ctl00_SchoolYear1_lblSchoolName"><b>e-School</b></span>&nbsp;
    
    &nbsp;
    <span id="ctl00_SchoolYear1_lblSchoolyear"> - Năm học: </span>
    <select name="ctl00$SchoolYear1$ddlSchoolYear" onchange="javascript:setTimeout('__doPostBack(\'ctl00$SchoolYear1$ddlSchoolYear\',\'\')', 0)" id="ctl00_SchoolYear1_ddlSchoolYear" class="dropdownlist">
	<option selected="selected" value="1201">2011 - 2012</option>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    <tbody><tr>
        ...
        <td style="width: 20%;">
            <select name="ctl00$ContentPlaceHolder1$UITypeWork1$ddlTypeWorkGroupSearch" id="ctl00_ContentPlaceHolder1_UITypeWork1_ddlTypeWorkGroupSearch" class="dropdownlist" style="width:90%;">
	<option selected="selected" value="0">[Tất cả]</option>
	<option value="1">Nhân viên</option>
	<option value="2">Giáo viên</option>
	<option value="3">Cán bộ quản lý</option>
        ...
        <td style="width: 25%;">
            <input name="ctl00$ContentPlaceHolder1$UITypeWork1$txtName" maxlength="50" id="ctl00_ContentPlaceHolder1_UITypeWork1_txtName" class="TextBox" style="width: 90%;" type="text">
        </td>
        <td style="width: 25%;">
                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$btnSearch" value="Tìm kiếm" id="ctl00_ContentPlaceHolder1_UITypeWork1_btnSearch" class="Cursor" style="width: 80px;" type="submit">
            </td>
    </tr>
    <tr>
...
<div id="ctl00_ContentPlaceHolder1_UITypeWork1_uplResult">
	
        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$hddTypeOfWorkId" id="ctl00_ContentPlaceHolder1_UITypeWork1_hddTypeOfWorkId" type="hidden">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody><tr>
                <td style="width: 400%;" align="left">
                    <span id="ctl00_ContentPlaceHolder1_UITypeWork1_lblMsgDelete" class="SuccessMessage"></span>
                    <span id="ctl00_ContentPlaceHolder1_UITypeWork1_lblSuccessMessage" class="SuccessMessage"></span>
                    <span id="ctl00_ContentPlaceHolder1_UITypeWork1_lblResult" class="SearchResult">Tìm thấy 20 kết quả</span>
                </td>
        ...
        <div>
		<table class="Grid" rules="all" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork" style="width: 100%; border-collapse: collapse;" border="1" cellpadding="3" cellspacing="0">
			<tbody><tr class="GridHeader" align="center">
				<th scope="col" align="center">STT</th><th scope="col" align="center"><a href="#">Tên loại công việc</a></th><th scope="col" align="center"><a href="#">Nhóm công việc</a></th><th scope="col" align="center">Xóa</th>
			</tr><tr class="GridItem">
				<td style="width: 10%; white-space: nowrap;" align="right">
                        1
                    </td><td style="width: 25%;" align="left">
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl02_lblTypeWorkName">Ban Giám Hiệu</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl02$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl02_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>

				</select>
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl02$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl02_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl02$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl02_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
				...
				<td style="width: 10%; white-space: nowrap;" align="right">
                        ...
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl03_lblTypeWorkName">Bảo mẫu</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl03$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl03_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>
                                ...
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl03$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl03_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl03$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl03_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
				...
				<td style="width: 10%; white-space: nowrap;" align="right">
                        ...
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl04_lblTypeWorkName">Dự khuyết</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl04$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl04_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>
                                ...
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl04$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl04_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl04$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl04_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
				...
				<td style="width: 10%; white-space: nowrap;" align="right">
                        ...
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl05_lblTypeWorkName">Giáo viên Anh văn</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl05$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl05_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>
                                ...
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl05$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl05_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl05$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl05_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
				...
				<td style="width: 10%; white-space: nowrap;" align="right">
                        ...
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl06_lblTypeWorkName">Giáo viên Mỹ thuật</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl06$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl06_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>
                                ...
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl06$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl06_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl06$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl06_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
				...
				<td style="width: 10%; white-space: nowrap;" align="right">
                        ...
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl07_lblTypeWorkName">Giáo viên Nhạc</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl07$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl07_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>
                                ...
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl07$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl07_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl07$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl07_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
				...
				<td style="width: 10%; white-space: nowrap;" align="right">
                        ...
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl08_lblTypeWorkName">Giáo viên Tin học</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl08$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl08_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>
                                ...
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl08$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl08_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl08$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl08_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
				...
				<td style="width: 10%; white-space: nowrap;" align="right">
                        ...
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl09_lblTypeWorkName">Giáo viên Thể dục</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl09$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl09_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>
                                ...
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl09$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl09_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl09$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl09_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
				...
				<td style="width: 10%; white-space: nowrap;" align="right">
                        ...
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl10_lblTypeWorkName">Tài vụ</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl10$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl10_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>
                                ...
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl10$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl10_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl10$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl10_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
				...
				<td style="width: 10%; white-space: nowrap;" align="right">
                        ...
                        <span id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl11_lblTypeWorkName">Tạp vụ</span>
                    </td><td style="width: 15%;" align="center">
                                 
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl11$ddlTypeWorkGroupGrd" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl11_ddlTypeWorkGroupGrd" disabled="disabled" class="dropdownlist" style="width:100%;">
					<option selected="selected" value="0">[Lựa chọn]</option>
					<option value="1">Nhân viên</option>
					<option value="2">Giáo viên</option>
					<option value="3">Cán bộ quản lý</option>
                                ...
                                <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl11$hdfTypeWorkGroupID" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl11_hdfTypeWorkGroupID" type="hidden">
                            </td><td style="width: 6%;" align="center">
                        <input name="ctl00$ContentPlaceHolder1$UITypeWork1$grvTypeOfWork$ctl11$imgBtnDelete" id="ctl00_ContentPlaceHolder1_UITypeWork1_grvTypeOfWork_ctl11_imgBtnDelete" title="Xóa loại công việc" src="/MenuPortlet/resource_files/delete.png" onclick="javascript:return confirm('Bạn có chắc muốn xóa loại công việc này không?');" style="border-width: 0px;" type="image">
                             
                    </td>
			</tr><tr class="GridPager" align="left">
				<td colspan="4"><table border="0">
					<tbody><tr>
						<td><span>1</span></td><td><a href="#">2</a></td>
					</tr>
				</tbody></table></td>
			</tr>
		</tbody></table>
            ...
            <div class="vtt_conrer_ct">
                <table border="0" cellpadding="2" cellspacing="2" width="100%">
                    <tbody><tr>
                        ...
                        <td style="width: 70%;">
                            <span id="ctl00_ContentPlaceHolder1_UITypeWork1_lblMsg" class="SuccessMessage"></span>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                     ...
                     <tr>
                            ...
                            <td colspan="2">
                                <span id="ctl00_ContentPlaceHolder1_UITypeWork1_ddlTypeWorkGroupRequired" style="color:Red;display:none;">Bạn chưa chọn loại công việc</span>
                            </td>
                        </tr>
                    <tr>
                        <td align="right">
                            Tên loại công việc&nbsp;<font color="red">*</font>
                        </td>
                        <td align="left">
                            <span id="ctl00_ContentPlaceHolder1_UITypeWork1_RequiredFieldValidator1" style="color:Red;display:none;">Loại công việc phải nhập</span>
                            <input name="ctl00$ContentPlaceHolder1$UITypeWork1$txtNamePopUp" maxlength="50" id="ctl00_ContentPlaceHolder1_UITypeWork1_txtNamePopUp" class="TextBox" style="width: 100%;" type="text">
                        </td>
                        <td>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <td style="width: 65%;">
                                <select name="ctl00$ContentPlaceHolder1$UITypeWork1$ddlTypeWorkGroup" id="ctl00_ContentPlaceHolder1_UITypeWork1_ddlTypeWorkGroup" class="dropdownlist" style="width:70%;">
			<option selected="selected" value="1">Nhân viên</option>
			<option value="2">Giáo viên</option>
			<option value="3">Cán bộ quản lý</option>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="ctl00$ContentPlaceHolder1$UITypeWork1$txtDesciptionPopUp" rows="4" cols="20" id="ctl00_ContentPlaceHolder1_UITypeWork1_txtDesciptionPopUp" class="TextBox" onkeydown="textareaCounter(this, 100,'Mô tả')" onkeyup="textareaCounter(this, 100,'Mô tả')" style="height: 30px; width: 100%;"></textarea>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        <td colspan="2" align="right">
                            <input name="ctl00$ContentPlaceHolder1$UITypeWork1$btnSave" value="Lưu" onclick='return validateSave() ;WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions("ctl00$ContentPlaceHolder1$UITypeWork1$btnSave", "", true, "popup", "", false, false))' id="ctl00_ContentPlaceHolder1_UITypeWork1_btnSave" class="Cursor" style="width: 80px;" type="submit">
                            &nbsp;&nbsp;
                            <input name="ctl00$ContentPlaceHolder1$UITypeWork1$btnClose" value="Đóng" onclick="javascript:return HideModalPopup();" id="ctl00_ContentPlaceHolder1_UITypeWork1_btnClose" class="Cursor" style="width: 80px;" type="submit">
                            &nbsp;
                        </td>
                    </tr>
                </tbody></table>
...
<script type="text/javascript">
    ...
    function resetForm() {
        ...
        <div class="GridFull" id="Footer">
            
            <div class="GridFix">
                <div class="Bottom">
                    <span id="ctl00_lblCopyRight">Demo</span>
                </div>
            </div>
        </div>
    </div>
